...
| 12  | [Phase 2 Scale-Out Architecture](design/12_Phase_2_Scale_Out_Architecture.md)               | Recommended scalable modular monolith, mixed IM traffic routing, Phase 2 delivery gates, capacity validation, and Phase 3 extraction vision                     |
