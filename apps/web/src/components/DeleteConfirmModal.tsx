export const DeleteConfirmModal = ({
  ...
  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60" onClick={onCancel}>
    <div className={`w-72 rounded-2xl border ${isLight ? "border-slate-200 bg-white" : "border-slate-700 bg-slate-900"} p-4 shadow-2xl`} onClick={(event) => event.stopPropagation()}>
